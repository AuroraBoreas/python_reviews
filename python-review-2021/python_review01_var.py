...
<built-in method today of type object at 0x53065788>
>>> datetime.datetime.today()
datetime.datetime(2021, 1, 14, 8, 26, 52, 267766)
>>> import time
>>> time.time()
1610586077.4098387
>>> time.now()
...
>>> datetime.datetime.today()
datetime.datetime(2021, 1, 14, 9, 1, 35, 604682)
>>> # var: primitive types, type conversions, type min, type max
...
>>> var = 1
>>> var = 2.718
>>> var = 3.14
