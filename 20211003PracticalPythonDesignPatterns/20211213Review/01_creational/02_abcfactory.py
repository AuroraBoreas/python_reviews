...
class AbstractFactory(ABC):
    @abstractmethod
    def make_prodcut_a(self)->AbstractProductA: pass
    @abstractmethod
    def make_prodcut_b(self)->AbstractProductB: pass

class Factory1(AbstractFactory):
    def make_prodcut_a(self) -> AbstractProductA:
        return ProductA1()

    def make_prodcut_b(self) -> AbstractProductB:
        return ProductB1()
