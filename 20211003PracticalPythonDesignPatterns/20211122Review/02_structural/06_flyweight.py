...
class FlyweightFactory:
    ...
    def get_state(self, shared_state:Dict)->str:
        return '_'.join(sorted(shared_state))

    def get_flyweight(self, shared_state:Dict)->str:
    ...
    def list_flyweights(self)->str:
        print(f'{self.__class__}: i have {len(self.get_flyweight)} flyweights:')
        return ''.format('\n'.join(self._flyweights), end='')